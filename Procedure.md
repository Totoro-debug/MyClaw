...
| #5 | T04 Configuration | #4 | B04 | `myclaw`, `myclaw config`, validated/redacted config API | b04_issue_5 | VERIFIED | pending batch commit |
...
| B04 | #5 | 141 pytest + Ruff lint/format + strict mypy + sdist/wheel + installed CLI smoke | pending | pending | VERIFIED |
| B05 | #6, #13 | - | - | - | TODO |
| B06 | #7 | - | - | - | TODO |
| B07 | #8 | - | - | - | TODO |
| B08 | #9, #11 | - | - | - | TODO |
