...
> Superseded transport note: this is a historical pre-#171 projection decision. Its
> model-call boundary remains evidence for the current UI behavior, but the former
> Conversation Port mapping was replaced by Agent Loop's sparse Message Bus output.
