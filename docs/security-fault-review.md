...
| --- | --- | --- | --- | --- |
| Filesystem / Workspace / artifacts | AC1, AC2, AC3 | Fixed file Tools resolve and canonicalize Workspace paths, allow Workspace State, request confirmation outside Workspace, and write direct UTF-8 artifacts at the BaseTool-owned path. | [base.py](../myclaw/tools/base.py), [read_file.py](../myclaw/tools/core/read_file.py), [write_file.py](../myclaw/tools/core/write_file.py), [host_filesystem.py](../myclaw/utils/host_filesystem.py), [run.py](../myclaw/agent/run.py) | [file Tools](../tests/tools/core/test_file_tools.py), [artifact seam](../tests/agent/test_run.py) |
